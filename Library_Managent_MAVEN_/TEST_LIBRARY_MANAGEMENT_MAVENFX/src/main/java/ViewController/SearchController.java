...
public class SearchController implements IUserProfileView {
    ...
    public void setContainer(AnchorPane container, User user){
        this.user = user;
        this.container = container;
        System.out.println("Welcome to the SearchView " + user.getFirstName());
         loadData();
    }
    
    private void loadData(){
        presenter.DisplayData(SearchContainer, container, user);
    }
