...
public class UserProfileViewController implements IUserProfileView{
    ...
    private void animate(HBox box, ImageView image, Label label){
     ...
     public void setCurrentUser(User user){
        this.user = user;
        System.out.println("Welcome to the ProfileView "+ user.getFirstName());
        ProfileViewLoad();
    }
    
    private void ProfileViewLoad(){
         userPresenter.DisplayPane(ViewContainer,"/Library_Management_Maven/UserProfilePanel", "null",user);
    }
    
    public void setContainer(AnchorPane anchor){
        ProfileViewLoad();
    }
    ...
    private void GotoSearch(){
        userPresenter.DisplayPane(ViewContainer,"/Library_Management_Maven/SearchView", "null",user);
    ...
    private void GotoReservation(){
        userPresenter.DisplayPane(ViewContainer,"/Library_Management_Maven/Reservation","Reservation",user);
    }
    
    @FXML
    private void GotoFavorites(){
        userPresenter.DisplayPane(ViewContainer,"/Library_Management_Maven/Reservation" , "Favorite",user);
    }
    
    @FXML
    private void GotoHistory(){
        userPresenter.DisplayPane(ViewContainer,"/Library_Management_Maven/Reservation" , "History",user);
    }
